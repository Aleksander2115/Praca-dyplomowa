		...
		<div id="page-wrapper">
				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
                            ...
                            <li><a href="{{ route('login') }}" class="button">Log in</a></li>
						</ul>
					</nav>
				</header>
			...
			<!-- One -->
				{{-- <section id="one" class="spotlight style1 bottom">
					<span class="image fit main"><img src="{{ asset('assets/images/piorun3.jpg') }}" alt="" /></span>
					<div class="content">
						<div class="container">
							<div class="row">
			...
			<!-- ONE -->
				<section id="one" class="spotlight style2 right">
					<span class="image fit main"><img src="{{ asset('assets/images/piorun4.jpg') }}" alt="" /></span>
					<div class="content">
						<header>
			...
			<!-- TWO -->
				<section id="two" class="spotlight style3 left">
					<span class="image fit main bottom"><img src="{{ asset('assets/images/piorun1.webp') }}" alt="" /></span>
					<div class="content">
						<header>
							<h2>Cars</h2>
